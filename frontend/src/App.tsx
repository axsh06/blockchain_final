                  ...
                  <div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-mono font-bold text-white">
                        {vaultShares
                          ? parseFloat(
                              formatEther(vaultShares as bigint),
                            ).toFixed(4)
                          : "0.0000"}{" "}
                        vTKN
                      </p>
                  ...
                  <div className="border border-gray-800 rounded p-4 mb-4">
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="font-bold text-white">
                        Proposal #1: Change Pool Fee Parameter
                      </h3>
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      This proposal executes parameter updates via Timelock
                      Controller.
                    </p>
                    <div className="flex space-x-2">
                      <button
                        onClick={() => handleVote("1", 1)}
                        className="flex-1 border border-gray-700 hover:border-white text-white text-sm py-2 rounded"
                      >
                        Vote FOR
                      </button>
                      <button
